...
# Сайт создан на php, так как сайт, к которому будет в будущем подгружаться админ панель, использует php. А также php использован для подгрузки данных из SQLite.
...
### В cmd перейти в cd C:\OSPanel\domains\AdminPanel\admin-panel
## И запустить npm run dev
