...
<body>
    ...
    <main>
        <h2>Основное меню</h2>
        <?php
        $categories = $db->query("SELECT * FROM menu_categories WHERE menu_type = 'main' ORDER BY sort_order");
        ...
        <div class="menu-section">
            ...
            <?php while ($item = $items->fetchArray(SQLITE3_ASSOC)): $hasItems = true; ?>
            <div class="menu-item">
